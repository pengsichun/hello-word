 ...
 */
uint32_t _sha256_init(sha256_context_t *ctx);
 ...
 */
uint32_t _sha256_update(sha256_context_t *ctx, const uint8_t * data, const size_t len);
 ...
 */
uint32_t _sha256_final(sha256_context_t *ctx, uint8_t * hash, uint8_t le);
